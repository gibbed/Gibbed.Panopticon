...
namespace Gibbed.Panopticon.FileFormats.MachineItemSpecs
{
    ...
    internal class SmallTableHeader
    {
        ...
        public ILabel<ushort> CountLabel;
        ...
        internal void Read(ReadOnlySpan<byte> span, ref int index, Endian endian)
        {
            ...
            this.Count = span.ReadValueU16(ref index, endian);
        ...
        {
            this.CountLabel = writer.WriteUInt16Pointer(labeler);
            this.OffsetLabel = writer.WritePointer(labeler);
        }

        internal void Set(ushort count, int offset)
        {
