...
namespace Gibbed.Panopticon.Common
{
    public sealed class SimpleBufferWriter<T> : IBufferWriter<T>
    {
        ...
        public Memory<T> GetMemory(int sizeHint = 0)
        {
            ...
            return sizeHint == 0
                ? this._Buffer.AsMemory(this._Offset + this._WriteIndex)
                : this._Buffer.AsMemory(this._Offset + this._WriteIndex, sizeHint);
        }
        ...
        public Span<T> GetSpan(int sizeHint = 0)
        {
            ...
            return sizeHint == 0
                ? this._Buffer.AsSpan(this._Offset + this._WriteIndex)
                : this._Buffer.AsSpan(this._Offset + this._WriteIndex, sizeHint);
        }
